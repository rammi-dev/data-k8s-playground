...
# Component: Kafbat UI (Kafka Web UI)
KAFKA_UI_ENABLED=$(load_config '.components.kafka_ui.enabled' 'false')
KAFKA_UI_NAMESPACE=$(load_config '.components.kafka_ui.namespace' 'kafka')
KAFKA_UI_CHART_REPO=$(load_config '.components.kafka_ui.chart_repo' 'https://kafbat.github.io/helm-charts')
KAFKA_UI_CHART_NAME=$(load_config '.components.kafka_ui.chart_name' 'kafka-ui')
KAFKA_UI_CHART_VERSION=$(load_config '.components.kafka_ui.chart_version' '1.6.0')
...
export KAFKA_UI_ENABLED KAFKA_UI_NAMESPACE KAFKA_UI_CHART_REPO KAFKA_UI_CHART_NAME KAFKA_UI_CHART_VERSION
