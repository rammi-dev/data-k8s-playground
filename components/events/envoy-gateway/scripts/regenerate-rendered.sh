...
echo "Regenerating Envoy Gateway Helm templates"
...
helm template envoy-gateway "$HELM_DIR" \
...
# ============================================================================
# STEP 4: Copy custom manifests (Gateway resources)
# ============================================================================
...
echo "  kubectl apply -f $RENDERED_DIR/envoy-gateway-playground/templates/"
