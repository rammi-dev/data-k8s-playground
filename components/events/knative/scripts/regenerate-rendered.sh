...
echo "Regenerating Knative Operator Helm templates"
...
helm template knative-operator "$HELM_DIR" \
...
echo "  kubectl apply -f $RENDERED_DIR/knative-playground/templates/"
