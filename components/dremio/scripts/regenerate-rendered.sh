...
if [[ -f "$ENV_FILE" ]]; then
    ...
    DREMIO_MONGODB_USER="dremio"
    DREMIO_MONGODB_PASSWORD="PLACEHOLDER"
    DREMIO_MONGODB_ADMIN_USER="clusterAdmin"
    DREMIO_MONGODB_ADMIN_PASSWORD="PLACEHOLDER"
    DREMIO_MONGODB_MONITOR_USER="clusterMonitor"
    DREMIO_MONGODB_MONITOR_PASSWORD="PLACEHOLDER"
    DREMIO_MONGODB_BACKUP_USER="backup"
    DREMIO_MONGODB_BACKUP_PASSWORD="PLACEHOLDER"
    DREMIO_MONGODB_USERADMIN_USER="userAdmin"
...
type: Opaque
stringData:
  ${DREMIO_MONGODB_USER:-dremio}: "${DREMIO_MONGODB_PASSWORD:-PLACEHOLDER}"
EOF
...
type: Opaque
stringData:
  MONGODB_CLUSTER_ADMIN_USER: "${DREMIO_MONGODB_ADMIN_USER:-clusterAdmin}"
  MONGODB_CLUSTER_ADMIN_PASSWORD: "${DREMIO_MONGODB_ADMIN_PASSWORD:-PLACEHOLDER}"
  MONGODB_CLUSTER_MONITOR_USER: "${DREMIO_MONGODB_MONITOR_USER:-clusterMonitor}"
  MONGODB_CLUSTER_MONITOR_PASSWORD: "${DREMIO_MONGODB_MONITOR_PASSWORD:-PLACEHOLDER}"
  MONGODB_BACKUP_USER: "${DREMIO_MONGODB_BACKUP_USER:-backup}"
  MONGODB_BACKUP_PASSWORD: "${DREMIO_MONGODB_BACKUP_PASSWORD:-PLACEHOLDER}"
  MONGODB_USER_ADMIN_USER: "${DREMIO_MONGODB_USERADMIN_USER:-userAdmin}"
